                    ...
                    <Row className="align-items-center">
                        <Col md={6}>
                            <h2 className="fw-bold text-primary">
                                Mua Via đã Xác Minh Danh Tính Quảng Cáo Facebook
                            </h2>
                            <p className="mt-3">
                                Chào mừng bạn đến với <strong>VuaVia.VN</strong>. Chúng tôi là một đơn vị cung cấp via xmdt (Xác minh danh tính) các loại uy tín, lâu năm, có nhiều kinh nghiệm trong vấn đề về Via. Vua Via là địa chỉ mua via việt, thái, indo, us, … xmdt giá rẻ. Tài khoản Via XMDT được giao có đầy đủ Email bảo mật, 2FA đảm bảo an toàn cho khách hàng.
                            </p>
                            <div className="mt-4">
