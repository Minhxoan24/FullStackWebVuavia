...
const MailOutLook = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                setLoading(true);
                const data = await getListtypeproductByCateGory(9);
                    ...
                    <Row className="align-items-center">
                        <Col md={6}>
                            <h2 className="fw-bold text-primary">
                                Mua Mail Outlook, Hotmail Chuyên dùng Verify, Nhận OTP
                            </h2>
                            <p className="mt-3">
                                Chào mừng bạn đến với VuaVia.VN . Chúng tôi là một đơn vị cung cấp Hotmail, Outlook các loại uy tín, lâu năm, có nhiều kinh nghiệm trong vấn đề về Mail. Vua Via là địa chỉ mua Hotmail, Outlook giá rẻ. Tài khoản Email được giao đầy đủ thông tin bảo mật, đảm bảo an toàn cho khách hàng.
                            </p>
                            <div className="mt-4">
