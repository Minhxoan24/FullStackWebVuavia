...
const AccSpam = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const data = await getListtypeproductByCateGory(5);
          ...
          <Row className="align-items-center">
            <Col md={6}>
              <h2 className="fw-bold text-primary">
                Mua Via Chuyên dùng cho spam, seeding
              </h2>
              <p className="mt-3">
                Chào mừng bạn đến với VuaVia.VN . Chúng tôi là một đơn vị cung cấp via các loại uy tín, lâu năm, có nhiều kinh nghiệm trong vấn đề về Via. Vua Via là địa chỉ mua via chuyên dùng cho việc spam, seeding, bán hàng giá rẻ. Tài khoản Via được giao có đầy đủ Email bảo mật, 2FA đảm bảo an toàn cho khách hàng.
              </p>
              <div className="mt-4">
